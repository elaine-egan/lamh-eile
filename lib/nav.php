<?php
namespace Carawebs\LamhEile\Nav;
 ...
 *
 * Carawebs_Nav_Walker example output:
...
/*
    $background_colour = get_post_meta( $item->ID, '_cw_colour', true );
    if ( !empty ( $background_colour ) ){

      $new_tag = "<li style='background-color: $background_colour'";
      $item_html = str_replace('<li', $new_tag, $item_html);
